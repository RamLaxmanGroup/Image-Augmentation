...
def get_child_augmenters():
    ...
    child_augment_dict['GaussianBlur'] = augmenters.blur.GaussianBlur(sigma=(0.0, 3.0))
    child_augment_dict['MotionBlur'] = augmenters.blur.MotionBlur(k=7)
...
def apply_augmentations():
    ...
    transformations_someof = augmenters.SomeOf(n=(2, 12),children=list(child_augment_dict.values()))
